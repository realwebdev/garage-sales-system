// sqldb provides support for access the database.
package sqldb
...
// StatuCheck returns nil if it can successfully talk to the database.
...
func StatusCheck(ctx context.Context, db *sqlx.DB) error {
	...
	// Return a simple query to determine connectivity.
	// Running this query force a roundtrip through the database.
	const q = `SELECT TRUE`
	var tmp bool
...
// NamedExecContext is a helper function  to execute a CUD
// operation with logging and tracing where field replacement
// is necessary.
...
// QuerySlice is a helper function for executing queries that return
// a collection of data to be unmarshalled into a slice.
