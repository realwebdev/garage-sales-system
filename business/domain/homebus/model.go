...
// Home represents and individual home.
type Home struct {
	ID          uuid.UUID
	UserID      uuid.UUID
	Type        home.Home
...
// UpdateHome defines what information may be provided to modify an
// existing Home. All fields are optional so clients can send only
// the fields they want changed. It uses pointer fields so we can
// differentiate between a field that was not provided and a field
// that was explicitly blank. Normally we do not want to use pointer
