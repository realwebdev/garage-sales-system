...
// Equal provides support for the go-cmp pacakge and testing.
func (q Quantity) Equal(q2 Quantity) bool {
	return q.value == q2.value
}

// MarshalText provides support for logging and any marshal needs.
func (q Quantity) MarshallText() ([]byte, error) {
...
// complies with the rules for a quantity. If an error occur the
// function panics.
