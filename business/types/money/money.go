...
// Strings returns the value of money.
...
// Parse parses the float value and returns a money if the value
// complies with the rules for money.
...
// MustParse parses the string value and returns a money if the
// value complies with the rules for money. If an error occurs
// function panics.
