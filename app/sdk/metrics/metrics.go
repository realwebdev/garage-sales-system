...
// This the single instance of the metrics value needed for collecting
// metrics. The expvar package is already based on a singleton
...
// The metrics value is stored in a package level varibale since everything
// inside of expvar is registered as a singleton. The ise of once will make sure
